...
const { Square, Triangle, Circle, Triangle } = require("./shapes");
...
describe("Triangle", () => {
  ...
  expect(Triangle.render()).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><triangle cx="150" cy="100" r="80" fill="green" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="black">hello world</text></svg>`)
  // Verify
